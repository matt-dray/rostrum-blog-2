...
The base R function `type.convert()` exists. Handy for 'simplifying' all the columns of a dataframe to appropriate data types.

<div class="tip"> 
`r fontawesome::fa("exclamation-circle")` <b>Note</b>

{a11ytables}---used as an example in this post---has been renamed [{aftables}](https://github.com/best-practice-and-impact/aftables) and is now maintained by the UK government's Analysis Function team. You can find it [on CRAN](https://cran.r-project.org/package=aftables).
