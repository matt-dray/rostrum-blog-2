...
In short, I made the Shiny app, which is embedded below (may take a moment to load).
...
So this was an excuse chance to polish some Shiny knowledge, basically. Simpler versions of this tool are possible, of course; I started out this mini project with just a basic {reactable} of the deadline information. I see [Hadley has now done something similar to that](https://hadley.github.io/cran-deadlines/)[^hadley] and it's a better tool[^shame].
