...
![Hex logo: evolution line of a {tamRgo} digital pet (species Y, 'hat guy').](resources/tamRgo_hex.png){fig-alt="Six pixellated characters showing a progression from a small blob creature, through to a larger hat-wearing creature, through to a tombstone." width="50%"}
...
```{r see-pet-many-filths, eval=FALSE}
see_pet()
```
```
░░░░░░░░░░
