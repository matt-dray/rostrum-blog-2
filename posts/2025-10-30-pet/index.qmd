...
As in [several recent posts](https://www.rostrum.blog/index.html#category=uv), uv has also been great here for the development loop, including to support use of ruff and ty[^astral] for code quality, like `uvx ruff format`.
...
[^astral]: [Astral](https://astral.sh/): please don't bait-and-switch me, I need this.