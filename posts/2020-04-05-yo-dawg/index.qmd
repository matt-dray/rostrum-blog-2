...
This has opened the door to yet another ground-breaking viz. The secret yet obvious real purpose of {ggpattern} is to [put plots inside your plots](https://twitter.com/mattdray/status/1245376176564187141?s=20).[^chartjunk]
...
[^chartjunk]: [It can't be chartjunk if it's simply more charts](https://twitter.com/mattdray/status/1245441179673661441?s=20), he said, posting a tweet on April 1st.
