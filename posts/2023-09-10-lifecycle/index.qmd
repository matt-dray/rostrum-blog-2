...
The tidyverse uses the [{lifecycle} package](https://CRAN.R-project.org/package=lifecycle) to advertise to users the current state of a function or argument. There's a good [explanatory vignette about lifecycles](https://lifecycle.r-lib.org/articles/stages.html) if you want to learn more.
