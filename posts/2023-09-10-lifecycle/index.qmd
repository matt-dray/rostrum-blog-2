...
The tidyverse uses the [{lifecycle} package](https://CRAN.R-project.org/package=lifecycle) to advertise to users the current state of a function or argument, via a badge in the help files. There's a good [explanatory vignette about lifecycles](https://lifecycle.r-lib.org/articles/stages.html) if you want to learn more. The badges look like this: [![](https://img.shields.io/badge/lifecycle-deprecated-orange?style=flat&labelColor=#4E4E4E){fig-align="left"}](https://lifecycle.r-lib.org/articles/stages.html#deprecated)
...
And here's how that it's laid out for an argument:
