...
Hm, I'll have to find out the correct place to put the font file so it can be used in this visualisation. The font should appear in an 8-bit style, like in the screenshot at the top of the post.
