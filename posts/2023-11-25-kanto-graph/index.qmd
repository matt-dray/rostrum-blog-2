...
It's interesting to see the simple radial networks around each city; the complicated relationships between the nodes of Silph Co; the long 'tail' from Victory Road through the Elite Four to the Hall of Fame; and the hand-like structure of the Safari Zone.
