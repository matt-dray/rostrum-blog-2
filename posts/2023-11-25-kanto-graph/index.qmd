...
visNetwork(
  ...
  main = list(
    text = "Kanto",
    style = "font-family:pokemon-font,sans;font-size:30px;color:black;"
  ),
  submain = list(
    text = "A graph of locations in PKMN Red<br><br>",
    style = "font-family:pokemon-font,sans;font-size:15px;color:black;"
  ),
  footer = list(
    text = "Source: Nintendo and Game Freak via the pret/pokered dissassembly project",
    style = "font-family:pokemon-font,sans;font-size:8px;color:black;text-align:right;"
  )
) |>
  visEdges(
  ...
  visOptions(
    ...
    nodesIdSelection = list(
      ...
      style = "font-family:pokemon-font,sans;font-size:15px;color:red;"
    )
  ) |>
...
Hm, chances are you won't see the font as intended. I'll have to find out the correct place to put the font file so it can be used in this visualisation. The font should appear in an 8-bit style, like in the screenshot at the top of the post.
