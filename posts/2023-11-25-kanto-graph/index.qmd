...
I extracted data from the disassembled code of Pokémon Red to create an interactive graph of the locations and their connections. You can [jump to the graph](#visualise-graph) below.
