...
What does it do? It waits 30 seconds after RStudio starts up[^thespicemelange] and then restarts R[^restart].
...
[^dont2]: Don't.
[^dont3]: Don't.
[^dont4]: Fine, [do it](https://www.youtube.com/watch?v=lCscYsICvoA).
