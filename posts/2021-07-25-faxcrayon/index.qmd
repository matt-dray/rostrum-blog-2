...
![](resources/faxcrayon.png){fig-alt="A screenshot of the webpage faxcrayon that has the site title at the top with emojis of a fax machine and a crayon. Below are links to the source and other materials. Below that are some rectangular cards that show some art with the date, title and type of art, like whether its original or a recreation." width="100%"}

## tl;dr 

I used [the {bs4cards} package](https://bs4cards.djnavarro.net/articles/introduction.html) by [Danielle Navarro](https://djnavarro.net/) to create an effortless online 'gallery' of 'art' on a single [R Markdown page](https://rmarkdown.rstudio.com/).

<div class="tip"> `r fontawesome::fa("exclamation-circle")` <b>Note</b>

I wrote below about setting up a custom domain. I've not renewed the original domain for this site, so it will no longer live at faxcrayon dot art and I'm not responsible for whatever is at the address now. You can still access the site at [https://matt-dray.github.io/faxcrayon/](https://matt-dray.github.io/faxcrayon/), however.
...
So I did just that: I made a single page[^site] where each card displays an art piece I created with R code for [#RecreationThursday](https://twitter.com/search?q=%23recreationthursday), or whatever.
...
And the 'faxcrayon dot art' URL only cost two dollars to buy, so.
...
It can take half an hour or so for the domain dance to complete.
