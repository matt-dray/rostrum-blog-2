...
I made a [simple toy pixel-editor for the browser](https://connect.posit.cloud/matt-dray/content/01929f88-4e28-a552-bc1f-62fa999e2c63), which helped me learn about reacting to user clicks and implementing undo/redo in {shiny}.
...
The app is available [via Posit Connect Cloud](https://connect.posit.cloud/matt-dray/content/01929f88-4e28-a552-bc1f-62fa999e2c63) and [the source is on GitHub](https://github.com/matt-dray/little-pixel-fun-zone) (v0.3.0 at time of writing).
