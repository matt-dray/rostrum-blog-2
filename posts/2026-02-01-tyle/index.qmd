...
I'm writing [tyle](https://github.com/matt-dray/tyle) to help in my quest to get better at Python.
...
Tile objects contain information like whether they're traversable.
Tile-grid objects store the tile grid as a list of lists of tile objects and are responsible for printing the map. Entities serve as the blueprint for creating the player object, hosting parameters for tile coordinates and hit points, for example.
