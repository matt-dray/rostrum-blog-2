---
title: "Shitty R help from shitty AI"
date: 2024-03-15
slug: "ai-garbage"
...
These sites seem to have tens (hundreds?) of pages published on the same day without any attribution to a particular human. Either they have some very efficient staff or they assume no-one will check.

Perhaps most brazen though is the poor attention to detail. At least one of these sites retains the sentence:

> Certainly! Here are the two sections for adding <affiliate> and <affiliate> to your webpage:

Clearly someone has asked a chatbot for some text and it has obliged. And then they forgot to delete this telltale line from the output before pasting it into their website. And the biggest joke is that I found this on a page full of affiliate links.

### SEO

I found links to these sites as the top search result.

As is well known, people will just click the top links willy-nilly. These must be the most appropriate sites if they're top of the search rankings, right?

No. The answer is no. Google is gameable as heck and easily manipulated for clicks.
...
It's pretty common knowledge that many AIs are trained on data without the consent of original creators. How much content is stolen from people without their consent? Maybe it slurped up some of _your_ material against your will.
