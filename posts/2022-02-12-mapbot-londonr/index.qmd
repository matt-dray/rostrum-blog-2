...
![](resources/mapbotverse.jpg){fig-alt="A satellite image of Hyde Park in London, with an emoji robot placed in the centre." width="100%"}
...
The bot no longer runs on Twitter. You can read about how [I ported it to Mastodon](https://www.rostrum.blog/2023/02/09/londonmapbotstodon/) at [\@londonmapbot@botsin.space](https://fosstodon.org/@londonmapbot@botsin.space).
...
![](resources/automated.png){fig-alt="The profile information section of the londonmapbot Twitter profile, with a small robot icon to show that it's an automated account." width="100%"}
