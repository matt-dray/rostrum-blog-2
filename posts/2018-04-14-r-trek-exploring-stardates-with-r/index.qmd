...
description: To boldly analyse some esoteric text.
date: 2018-04-14
slug: r-trek-exploring-stardates
categories: [r, star-trek, text]
---

```{r renv, echo=FALSE, results='hide'}
# renv::use(lockfile = "renv.lock")
```

![](https://media.giphy.com/media/bKnEnd65zqxfq/giphy.gif){fig-alt="Captain Picard points and gives the order to 'make it so'." width=500}
...
![](https://media.giphy.com/media/OLPsCbh2N7QZi/giphy.gif){fig-alt="Captain Picard gives the order for Ensign Crusher to 'shut up, Wesley'." width=500}
