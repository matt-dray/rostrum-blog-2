...
posts$link <- gsub("posts", "https://www.rostrum.blog", dirname(post_paths))
...
`r emoji("new")` The latest post was published `r today() - max(posts$publish_date)` day(s) ago: [`r posts$title[1]`](`r posts$link[1]`)`r ifelse(grepl("[!|?|\\.|]$", posts$link[1]), "", ".")`
